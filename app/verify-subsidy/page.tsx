      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#4c9a4c] text-base">
            Scan the QR code to activate your 30% discount
          </p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center overflow-hidden rounded-lg h-14 px-4 bg-primary text-[#0d1b0d] text-base font-bold leading-normal tracking-[0.015em] hover:opacity-90 transition-opacity mb-4"
        >
          QR Code Verified ✓
        </button>
